...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Caishen",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Caishen17StylizedTextField")
...
SWIFT_CLASS("_TtC7Caishen20DetailInputTextField")
...
SWIFT_CLASS("_TtC7Caishen17CVCInputTextField")
...
SWIFT_PROTOCOL("_TtP7Caishen25CardInfoTextFieldDelegate_")
...
SWIFT_PROTOCOL("_TtP7Caishen28NumberInputTextFieldDelegate_")
...
SWIFT_CLASS("_TtC7Caishen13CardTextField")
...
@interface CardTextField (SWIFT_EXTENSION(Caishen))
...
@interface CardTextField (SWIFT_EXTENSION(Caishen)) <CardInfoTextFieldDelegate>
- (void)textField:(UITextField * _Nonnull)textField didEnterValidInfo:(NSString * _Nonnull)didEnterValidInfo;
- (void)textField:(UITextField * _Nonnull)textField didEnterPartiallyValidInfo:(NSString * _Nonnull)didEnterPartiallyValidInfo;
- (void)textField:(UITextField * _Nonnull)textField didEnterOverflowInfo:(NSString * _Nonnull)overFlowDigits;
@end
...
SWIFT_CLASS("_TtC7Caishen19MonthInputTextField")
...
SWIFT_CLASS("_TtC7Caishen20NumberInputTextField")
...
SWIFT_CLASS("_TtC7Caishen18YearInputTextField")
